...
function ProductDetail(){
    ...
    return(
        ...
        {context.isMobile
            ?
            <aside className={`${context.isProductDetailOpen ? 'flex' : 'hidden'} w-auto product-detail flex-col fixed right-0 bg-red-50 border border-black items-center`}>
            ...
            :
            <aside className={`${context.isProductDetailOpen ? 'flex' : 'hidden'} w-96 product-detail flex-col fixed right-0 bg-red-50 border border-black rounded-xl items-center`}>
            <div className='w-full flex justify-between items-center p-4'>
                <h2 className='font-medium text-xl '>
                    Detalles del producto
                </h2>
